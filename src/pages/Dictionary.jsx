              ...
              <div key={idx} className={`dict-masonry-card style-${item.style}`}>
                ...
                <div style={{ position: 'relative', zIndex: 2 }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '1.5rem' }}>
                    ...
                    {item.isArticle && (
                      <Link to={`/meaning/${item.slug}`} style={{ color: 'white', display: 'inline-flex', padding: '6px 14px', background: 'var(--primary)', borderRadius: '30px', fontWeight: 600, fontSize: '0.8rem', gap: '0.3rem', alignItems: 'center', textDecoration: 'none', boxShadow: '0 4px 12px rgba(139, 92, 246, 0.2)' }}>
